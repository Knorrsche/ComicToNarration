...
const images = [
  {
    ...
    explanation: `A reader with no visual impairment experiences comics exactly as intended by the artist: crisp line work, vivid and accurate colors, and full visibility of every panel’s composition.
  ...
  },
  {
    ...
    explanation: `With medium visual impairment, the experience of reading comics changes noticeably.The entire page appears slightly blurred, making it harder to read small or stylized fonts without magnification.

    Fine background details and delicate line art can be lost, and characters may appear less distinct from their surroundings. For example, the 2 silhouettes in panel 3 are almost indistinguishable. Page navigation can be slower, as the reader may need to move the page closer to their eyes or use assistive tools to make out dialogue and panel transitions.

    While the overall story can still be followed, much of the visual richness that gives comics their unique style may be diminished.`,
    src: Mediocore,
  },
  {
    ...
    To enjoy comics, readers at this level may rely on audio descriptions, tactile graphics, or highly zoomed-in digital versions with screen reading software to convey text and describe imagery.`,
    src: Severe,
  }
];
